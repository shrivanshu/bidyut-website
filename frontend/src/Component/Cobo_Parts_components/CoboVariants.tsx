...
const robotSpecs: RobotSpec[] = [
  {
    ...
    name: 'Z1 Arm',
    description:
      'The Z1 Arm is a high-precision robotic arm lightweight  with harmonic reducer, industrial-grade cross-roller bearings, and advanced torque control. It provides high accuracy, stable performance, and robust communication for industrial and research applications.',
    gallery: ['/Cobo/Z1-Arm.webp', '/Cobo/Z!-arm.webm'],
    features: [
      {
      ...
      },
      {
        ...
        detail:
          'Weight 405g, Φ65*52mm size, harmonic reducer with industrial-grade cross-roller bearings',
      ...
      },
      {
        ...
        detail:
          '24V recommended voltage, supports stiffness and damping control',
    ...
    features: [
      {
        ...
        detail:
          'Weight about 2.37Kg, compact and portable for versatile applications',
      ...
      },
      {
        label: 'Payload & Reach',
        detail:
          'Payload 500g, 550mm reach (without gripper), 670mm reach (with gripper)',
  ...
  },
  {
    ...
    description:
      'The Franka Research 3 is a state-of-the-art 7-DOF robotic arm built for advanced robotics research and human–robot interaction studies. Featuring exceptional force sensitivity, modular control architecture, and an elegant lightweight design, it enables safe, precise manipulation in labs, automation cells, and AI-driven projects.',
    gallery: [
    ...
    features: [
      {
        ...
        detail:
          'Torque sensors in every joint deliver sub-newton precision and soft, human-safe interaction.',
      ...
      },
      {
        ...
        detail:
          'Seven rotational joints provide human-arm-like reach and redundancy for complex tasks.',
      ...
      },
      {
        label: 'Payload & Reach',
        detail:
          'Payload up to 3 kg with an 855 mm reach, enabling both delicate and extended manipulation.',
      ...
      },
      {
        ...
        detail:
          'Approx. 18 kg total weight with sleek profile for easy lab integration and mobility.',
          ...
          >
            ...
            <div className='space-y-4'>
              <h3 className='text-lg font-semibold text-gray-800 dark:text-gray-200'>
                {translateWithFallback('coboGalleryHeading', 'Gallery')}
              </h3>
        ...
        <div className='fixed inset-0 bg-black bg-opacity-95 z-50 flex items-center justify-center'>
          <div className='relative w-full h-[80%] flex items-center justify-center p-4'>
            ...
            <div className='w-full h-full flex items-center justify-center'>
              ...
              displayGallery[currentImageIndex]?.endsWith('.webm') ? (
                <video
