          ...
          <div className="space-y-4">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-gray-100 leading-tight transition-colors duration-300">
              <span className="block md:inline">
                {translateWithFallback('go2DetailHeading', 'Ready to revolutionize')}
              </span>{' '}
              <span className="text-green-600 dark:text-green-400 block md:inline">
                {translateWithFallback('go2DetailHeadingHighlight', 'your classroom?')}
              </span>
            </h2>
            ...
            <div className="pt-4">
              ...
              >
                {translateWithFallback('go2DetailCta', 'Contact Sales Team')}
              </button>
            </div>
        </div>
      </div>
