...
const robotSpecs: RobotSpec[] = [
  ...
  },
  {
    ...
    name: 'G1 EDU U2',
    description:
      'The G1 EDU U2 builds upon U1 with extended battery life (10,500mAh), enhanced AI modules, and improved joint flexibility. It is tailored for advanced robotics coursework and real-world robotics competitions.',
    gallery: ['/media/Robot_Details.svg', '/media/G1 EDU U2.webp'],
    features: [
      {
  ...
  },
  {
    ...
    name: 'G1 EDU U3',
    description:
      'The G1 EDU U3 introduces advanced locomotion control, upgraded vision system with multi-camera SLAM, and reinforced joints for longer durability in research environments.',
    gallery: ['/media/Copy of G1 EDU U3 .webp'],
    features: [
      {
        label: 'Vision System',
  ...
  },
  {
    ...
    name: 'G1 EDU U4',
    description:
      'The G1 EDU U4 enhances AI computing with built-in Jetson Orin NX, integrates haptic feedback for hand control, and supports cloud-based simulation training.',
    gallery: ['/media/G1 EDU U4 .webp'],
    features: [
      {
        label: 'AI Module',
  ...
  },
  {
    ...
    name: 'G1 EDU U5',
    description:
      'The G1 EDU U5 focuses on collaborative research, with voice AI, advanced gesture recognition, and improved human-robot interaction modules.',
    gallery: ['/media/G1 EDU U5 .webp'],
    features: [
      {
        label: 'Voice AI',
  ...
  },
  {
    ...
    name: 'G1 EDU U6',
    description:
      'The G1 EDU U6 is the flagship model in the EDU series, combining all previous upgrades with AI-driven decision-making, cloud-edge hybrid control, and maximum safety features for real-world deployment in labs and competitions.',
    gallery: ['/media/G1 EDU U6  (1).webp'],
    features: [
      {
...
export default function RobotShowcase () {
  ...
  const filteredRobots = robotSearchData.filter(
    robot =>
                  ...
                  <div
                    ...
                    onClick={() => {
                      ...
                      const detailsSection =
                        document.getElementById('robot-details')
                ...
                {displayGallery.map((media: any, index: number) => (
                  ...
                  >
                    {media.endsWith('.mp4') || media.endsWith('.webm') ? (
                      ...
                      <img
                        src={media}
                        alt={`Humanoid education G1 - G1 educational robot for hands-on learning and robotics education - view ${
                          index + 1
                        }`}
                        className='w-full h-full object-cover'
                      />
            ...
            <div className='relative h-[600px] md:h-[700px] w-full'>
              ...
              >
                {currentSpec.features.map((feature, index) => {
                  ...
                  const startPos =
                    isSmScreen && feature.positionSm
                      ? feature.positionSm
                      : feature.position
                  const endPoint =
                    isSmScreen && feature.targetPointSm
                      ? feature.targetPointSm
                      : feature.targetPoint
