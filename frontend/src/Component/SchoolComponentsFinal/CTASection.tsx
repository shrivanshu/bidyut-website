  ...
  return (
    <section className="bg-white dark:bg-black py-20 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        Empower your students to think, build, and innovate through robotics, AI, and hands-on learning experiences, all within a fully equipped robotics lab setup.
      </p>
        <Link
  to="/Contact"
