    ...
    <section className="bg-white dark:bg-black py-20 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl font-body text-black dark:text-white mb-20 max-w-3xl mx-auto leading-relaxed">
          Empower your students to think, build, and innovate through robotics labs, AI, and hands-on learning experiences. Our modern robotics lab setup equips classrooms with the tools they need to explore, create, and excel,  ensuring every robotics lab in school becomes a center for innovation.     </p>
        <Link
          to="/Contact"
