...
const WhyBidyut: React.FC = () => {
  return (
    <section className="w-full bg-white relative font-['Roboto'] min-h-[300px] pb-10 mt-0 md:mt-4">
      {/* Heading */}
      <h2
      ...
      <h2
        className="block md:hidden text-center text-black font-semibold leading-snug px-4 mt-6"
        style={{
          fontSize: "28px",
          fontWeight: 600,
        }}
      ...
      <p
        className="block md:hidden text-center text-black font-medium leading-relaxed px-6 mt-3"
        style={{
          fontSize: "16px",
          fontWeight: 500,
        }}
