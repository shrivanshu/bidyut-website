...
export default function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="
        relative px-8 pt-44 pb-20 overflow-hidden transition-colors duration-300
    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="glass-card theme-aware p-8">
            ...
            <div className="space-y-3">
              <input
                ...
                className="
                  w-full px-4 py-3 rounded-lg transition-all focus:ring-2 focus:ring-emerald-500 focus:outline-none
                  bg-white/65 border border-emerald-600/25 text-gray-900 placeholder:text-gray-500
                  dark:bg-black/40 dark:border-emerald-500/35 dark:text-white dark:placeholder:text-gray-400
                  backdrop-blur-md
                "
              />
              <button
                className="
                  w-full bg-emerald-500 hover:bg-emerald-600 text-white font-medium py-3 px-4 rounded-lg transition-all
        ...
        <div className="flex space-x-4 mb-8 justify-left">
          {[Instagram, Facebook, Twitter].map((Icon, index) => (
            <div
              key={index}
              className="
                w-10 h-10 rounded-xl flex items-center justify-center cursor-pointer hover:scale-110 transition-all shadow-md
                bg-white/55 border border-emerald-600/25
                dark:bg-black/40 dark:border-emerald-500/35
                backdrop-blur-md
              "
              style={{
                boxShadow:
        ...
        <div className="relative w-full select-none">
          <h1
            className="
      text-5xl md:text-6xl lg:text-7xl font-bold tracking-wider
      text-transparent bg-clip-text
      bg-gradient-to-r from-[#00F5A0] to-[#00C6FF]
      w-full
    "
            style={{
              display: "block",
              textAlign: "center",
              transform: "scaleX(1.8)", // <-- stretch horizontally
