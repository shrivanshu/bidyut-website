...
const HeroSectionH1_2 = () => {
  ...
  <div className="max-w-[1440px] mx-auto flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-2">
    ...
    <div className="flex flex-wrap items-baseline justify-center sm:justify-start">
      <span className="text-xl sm:text-3xl md:text-[55px] font-oxanium font-semibold text-black dark:text-white drop-shadow-sm cursor-target">
        Let's
      </span>
      <span className="text-xl sm:text-3xl md:text-[55px] font-oxanium font-semibold text-black dark:text-white ml-2 drop-shadow-sm cursor-target">
        Innovate
      </span>
      <span className="text-xl sm:text-3xl md:text-[55px] font-oxanium font-semibold text-[#00ffa3] ml-2 drop-shadow-sm cursor-target">
        Learn
      </span>
    </div>
