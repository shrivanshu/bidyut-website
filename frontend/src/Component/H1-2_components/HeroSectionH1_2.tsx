  ...
  return (
    <>
      <div className='min-h-[120vh] bg-white pt-8 dark:bg-black relative overflow-hidden'>
        ...
        <div className='absolute top-[14%] md:top-[19%] left-0 md:left-3 right-0 md:right-4 z-20 px-4 md:px-14'>
          <div className='max-w-[1440px] mx-auto flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-2'>
            ...
            <div className='flex flex-wrap items-baseline justify-center sm:justify-start'>
              <span className='text-xl sm:text-3xl md:text-[55px] font-heading font-semibold text-black dark:text-white drop-shadow-sm cursor-target'>
                Let's
              </span>
              <span className='text-xl sm:text-3xl md:text-[55px] font-heading font-semibold text-black dark:text-white ml-2 drop-shadow-sm cursor-target'>
                Innovate
              </span>
              <span className='text-xl sm:text-3xl md:text-[55px] font-heading font-semibold text-[#00ffa3] ml-2 drop-shadow-sm cursor-target'>
                Learn
              </span>
            </div>
        ...
        <div className='absolute top-[25%] md:top-[30%] font-poppins left-[5%] z-5 max-w-[400px]'>
          <h2 className='text-[21px] md:text-[24px] font-bold text-black dark:text-white mb-4 cursor-target'>
            Unitree H1-2 Advanced Humanoid Robot
          </h2>
          <p className='text-[15px] md:text-[17px] font-semibold leading-[1.9] text-[#00000070] dark:text-white cursor-target'>
            At Bidyut Innovation, we are pioneering the future of robotics in
            India. The Unitree H1-2 Robot, a full-size humanoid robot, combines
            advanced mobility, perception, and human-like motion. Designed for
            industrial research, AI development, and dynamic automation, this
            humanoid robot empowers engineers, innovators, and researchers with
            unmatched performance and agility.
          </p>
        </div>
        ...
        <div className='absolute top-[86%] md:top-[68%] -left-[35%] md:left-0 -right-8 md:right-0 z-15 h-[200px]'>
          <div className='max-w-[1440px] mx-auto px-6 relative h-full'>
            ...
            <div className='absolute  left-36 md:left-20 -top-4 md:top-4'>
              <span
                className='text-[40px] md:text-[120px] lg:text-[220px] font-bold text-transparent bg-clip-text leading-none opacity-70 drop-shadow-lg cursor-target'
                style={{
                  letterSpacing: '-0.05em',
                  backgroundImage:
                    'linear-gradient(180deg, #c0c0c0 30%, #808080 40%, #000000 100%)'
                }}
              >
                H1-2
              </span>
        ...
        <div className='max-w-[1440px] mx-auto'>
          ...
          <div className='max-w-[980px] mx-auto'>
            <p className='text-gray-500 font-semibold text-xs sm:text-sm md:text-base leading-relaxed cursor-target'>
              Discover a range of high-performance full-size humanoid robots
              built for research, industry, and advanced robotics applications.
              Each model features 3D LiDAR, Intel RealSense depth sensing,
              high-torque joints, and powerful computing capabilities—ideal for
              AI experiments, industrial automation, and humanoid robotics
              development.
            </p>
          </div>
        </div>
...
export default HeroSectionH1_2
