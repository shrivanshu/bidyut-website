...
export default function H1_2Variants () {
  ...
  const displayDescription =
    selectedRobot?.description ?? t(`h1SpecDesc${specKey}`) ?? currentSpec.description
        ...
        <div className='grid lg:grid-cols-2 gap-12 items-start max-w-7xl mx-auto'>
          ...
          >
            <div className='space-y-6'>
              <h2 className='text-5xl md:text-6xl font-heading font-bold text-[#0ACF83] dark:text-gray-100 tracking-tight'>
                {displayName}
              </h2>
              <h3 className='text-xl md:text-2xl font-subheading text-gray-600 dark:text-gray-400 font-medium'>
