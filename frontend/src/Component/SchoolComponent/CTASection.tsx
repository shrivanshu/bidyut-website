  ...
  return (
    <section className="bg-white dark:bg-black py-20 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-4xl md:text-7xl font-bold font-roboto dark:text-white  text-black mb-6">Shape the Future with Us</h2>
        <p className="text-lg md:text-xl font-roboto text-black dark:text-white mb-20 max-w-3xl mx-auto leading-relaxed">
