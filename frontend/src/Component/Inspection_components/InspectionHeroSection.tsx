...
<div className="max-w-5xl md:max-w-6xl lg:max-w-7xl mx-auto mt-2 px-4">
  ...
  <img src="/GO2/GO2 ENT U2.webp" alt="B2 Hero" className="max-w-4xl h-full object-contain aspect-video mx-auto" />
    </div>
  </div>
  ...
  {/* Gradient Heading */}
  <h2
    className="text-6xl md:text-8xl lg:text-9xl  font-semibold leading-none text-transparent bg-clip-text mb-0"
    style={{
    backgroundImage:
