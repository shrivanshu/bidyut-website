...
const robotSpecs: RobotSpec[] = [
  {
    ...
    name: "B2-XJ1-A",
    description:
      "B2-XJ1-A includes all functions of B2 dog, B2 laser slam kit assembly, protective bracket (customizable), main control module, power module, contact charger assembly, emergency stop button, robot-side network module, inspection robot management platform (station-side software), and online technical support (training and documentation).",
    gallery: [
    ...
    features: [
      {
        label: "Laser Slam Kit Assembly",
        detail: "Basic version for autonomous mapping and navigation",
        position: { top: "5%", left: "20%" },
        positionSm: { top: "18%", left: "20%" },
        lineDirection: "right",
        targetPoint: { x: "25%", y: "35%" },
        targetPointSm: { x: "25%", y: "40%" }
      },
      {
        label: "Protective Bracket",
        detail: "Customizable protection bracket",
      ...
      {
        label: "Main Control Module",
        detail: "Core processing and power control",
        position: { top: "45%", left: "0%" },
        positionSm: { top: "65%", left: "10%" },
        lineDirection: "right",
        targetPoint: { x: "25%", y: "35%" },
        targetPointSm: { x: "25%", y: "40%" }
      }
  ...
  },
  {
    ...
    name: "B2-XJ1-B",
    description:
      "B2-XJ1-B includes all features of B2-XJ1-A with additional dual-light gimbal camera, temperature measurement capabilities, 360° rotation, and environmental protection for extreme conditions.",
    gallery: [
      "/media/B2-XJ1-B.png",
      "/media/B2-XJ1-B.png",
      "/media/B2-XJ1-B.png",
    ...
    features: [
      {
        ...
        detail: "32x optical zoom, supports 30m white light fill",
        position: { top: "5%", left: "60%" },
        positionSm: { top: "14%", left: "60%" },
        lineDirection: "right",
        targetPoint: { x: "25%", y: "35%" },
        targetPointSm: { x: "25%", y: "40%" }
      },
      {
        ...
        detail: "-20°C to 150°C, ±2°C accuracy",
        position: { top: "50%", left: "0%" },
        positionSm: { top: "65%", left: "5%" },
        lineDirection: "right",
        targetPoint: { x: "25%", y: "35%" },
        targetPointSm: { x: "25%", y: "40%" }
      },
      {
        label: "360° Continuous Rotation",
        detail: "0.5°–90°/s, IP67 protection",
        position: { top: "80%", left: "80%" },
        positionSm: { top: "65%", left: "87%" },
        lineDirection: "left",
  ...
  },
  {
    ...
    name: "B2-XJ1-C",
    description:
      "B2-XJ1-C includes all functions of B2-XJ1-B plus the Z1 Pro with D435i camera gripper for advanced inspection and manipulation tasks.",
    gallery: [
      "/media/B2-XJ1-C.png",
      "/media/B2-XJ1-C.png",
      "/media/B2-XJ1-C.png",
    ...
    features: [
      {
        label: "Z1 Pro Arm with D435i Camera Gripper",
        detail: "Advanced vision-guided gripper for manipulation",
        position: { top: "10%", left: "50%" },
        positionSm: { top: "15%", left: "50%" },
        lineDirection: "right",
        targetPoint: { x: "25%", y: "35%" },
        targetPointSm: { x: "25%", y: "40%" }
      }
...
export default InspectionVariants;
