        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-16 items-center">
          ...
          <div className="relative flex items-center justify-center">
            ...
            >
              ...
              {/* Company Logos */}
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["google"] = el
}}
              ...
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["microsoft"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["apple"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["amazon"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["netflix"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["spotify"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["adobe"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["tesla"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["slack"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              {/* GitHub - repositioned */}
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["github"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["linkedin"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["twitter"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["facebook"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["instagram"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              {/* Uber */}
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["uber"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              {/* Airbnb */}
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["airbnb"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              {/* Dropbox */}
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["dropbox"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              {/* Zoom */}
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["zoom"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              {/* Shopify */}
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["shopify"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              {/* PayPal */}
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["paypal"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              {/* Stripe */}
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["stripe"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              {/* Twitch */}
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["twitch"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              {/* TikTok */}
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["tiktok"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
              ...
              {/* Pinterest */}
              <motion.div
                ref={(el: HTMLDivElement | null) => {logoRefs.current["pinterest"] = el
}}
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                whileInView={{
                  opacity: 1,
