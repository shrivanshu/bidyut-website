...
<div className="max-w-5xl md:max-w-6xl lg:max-w-7xl mx-auto mt-2 px-4">
  ...
  <img src="/media/A2-w.webp" alt="Quadrupeds Industry A2-W - Industrial quadruped A2-W autonomous inspection robot for safety checks" className="max-w-4xl h-full object-contain aspect-video mx-auto" />
    </div>
  </div>
