        ...
        <div className='grid lg:grid-cols-2 gap-12 items-start max-w-7xl mx-auto'>
          ...
          >
            <div className='space-y-6'>
              <h2 className='text-2xl sm:text-3xl md:text-5xl font-bold text-gray-900 dark:text-gray-100 tracking-tight'>
                {displayName}
              </h2>
