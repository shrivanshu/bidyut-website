...
const robotImgSrc = '/media/B2 ADVANCED.webp';

const B2_Wells_Details = ({ onContactClick }: CobotClassroomProps) => {
  ...
  return (
    <div
      ...
      style={{ userSelect: 'text', WebkitUserSelect: 'text', msUserSelect: 'text' }}
    >
      <div className="w-full h-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        {/* Content */}
        <div
          className="space-y-6 md:order-2 order-2 text-center md:text-left w-full h-full flex flex-col justify-center select-text"
          style={{ userSelect: 'text', WebkitUserSelect: 'text', msUserSelect: 'text' }}
        >
          <div className="space-y-4">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-gray-100 leading-tight transition-colors duration-300">
              <span className="block md:inline">
                {translateWithFallback('b2wDetailHeading', 'Transform Workflows with')}
              </span>{' '}
              <span className="text-green-600 dark:text-green-400 block md:inline">
                {translateWithFallback('b2wDetailHeadingHighlight', ' B2-W Robot')}
              </span>
            </h2>
          ...
          <div className="pt-4">
            ...
            >
              {translateWithFallback('b2wDetailCta', 'Contact Sales Team')}
            </button>
          </div>
        </div>
      </div>
...
export default B2_Wells_Details;
