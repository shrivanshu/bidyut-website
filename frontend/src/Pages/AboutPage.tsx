...
const timelineData: TimelineItem[] = [
  ...
  },
  {
    ...
    description:
      "2023 was a landmark year. We officially became a Private Limited Company, strengthening our structure and vision for long-term impact. Alongside this milestone, we scaled our offerings to universities and R&D centers, introducing humanoid robots, quadrupeds, and collaborative robots (cobots). These advanced systems helped students and researchers push the boundaries of robotics exploration.",
  },
  {
    year: "2024",
    title: "Driving Industry Transformation",
    description:
      "2024 was the year of industry collaboration. We began delivering tailored robotics solutions for companies, empowering businesses with automation, efficiency, and next-generation robotics technology.",
  },
  {
    year: "2025",
    title: "Leading the Robotics Revolution",
    description:
      "Today, in 2025, we stand as a trusted Edutech & Robotics innovation partner—bridging schools, universities, and industries with cutting-edge solutions that shape the future of technology and learning.",
  },
];
...
export default function AboutPage() {
  ...
  const galleryImages = [
    // Mixed layout for better visual balance
    {
      ...
      category: "events",
      story:
        "Interactive workshops where learning meets innovation, bringing together students and educators.",
      bgColor: "#10B981",
    },
    {
      ...
      category: "robots",
      story:
        "State-of-the-art humanoid robots designed for educational and research purposes.",
      bgColor: "#EF4444",
    },
    {
      ...
      category: "students",
      story:
        "Students actively participating in hands-on robotics learning experiences.",
      bgColor: "#F59E0B",
    },
    {
      ...
      category: "projects",
      story:
        "Cutting-edge robotics projects that push the boundaries of technology and innovation.",
      bgColor: "#3B82F6",
    },
    {
      ...
      category: "training",
      story:
        "Comprehensive training programs for educators and professionals in robotics technology.",
      bgColor: "#8B5CF6",
    },
    {
      ...
      category: "events",
      story:
        "Exciting robotics competitions that challenge students to showcase their technical skills.",
      bgColor: "#10B981",
    },
    {
      ...
      category: "students",
      story:
        "Students collaborating on innovative projects that combine creativity with technology.",
      bgColor: "#F59E0B",
    },
    {
      ...
      category: "robots",
      story:
        "Industrial automation robots revolutionizing manufacturing and production processes.",
      bgColor: "#EF4444",
    },
    {
      ...
      category: "projects",
      story:
        "Real-world engineering projects that bridge theoretical knowledge with practical application.",
      bgColor: "#3B82F6",
    },
    {
      ...
      category: "events",
      story:
        "Educational seminars focused on advancing STEM learning methodologies.",
      bgColor: "#10B981",
    },
    {
      ...
      category: "training",
      story:
        "Advanced technical training sessions covering cutting-edge robotics and automation.",
      bgColor: "#8B5CF6",
    },
    {
      ...
      category: "students",
      story:
        "Young innovators exploring the limitless possibilities of robotics and engineering.",
      bgColor: "#F59E0B",
    },
    {
      ...
      category: "projects",
      story:
        "Collaborative projects fostering teamwork and innovative problem-solving approaches.",
      bgColor: "#3B82F6",
    },
    {
      ...
      category: "robots",
      story:
        "Educational robotics platforms designed to enhance STREAM learning experiences.",
      bgColor: "#EF4444",
    },
    {
      ...
      category: "events",
      story:
        "Innovation showcases highlighting breakthrough projects and creative solutions.",
      bgColor: "#10B981",
    },
    {
      ...
      category: "students",
      story:
        "Students developing technical mastery through practical, hands-on learning approaches.",
      bgColor: "#F59E0B",
    },
    {
      ...
      category: "training",
      story:
        "Interactive training workshops combining theoretical knowledge with practical skills.",
      bgColor: "#8B5CF6",
    },
    {
      ...
      category: "projects",
      story:
        "Technical project showcases demonstrating advanced engineering capabilities.",
      bgColor: "#3B82F6",
    },
    {
      ...
      category: "robots",
      story:
        "Autonomous robot systems capable of independent decision-making and navigation.",
      bgColor: "#EF4444",
    },
    {
      ...
      category: "training",
      story:
        "Specialized training programs designed for industry professionals and educators.",
      bgColor: "#8B5CF6",
    },
  ];
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setAutoScrollIndex(
        (prev) => (prev + 1) % Math.min(6, galleryImages.length)
      );
    ...
    return (
      ...
      >
        ...
        <div
          className={`${
            isDarkTheme ? "bg-black" : "bg-white"
          } min-h-[70vh] sm:min-h-screen relative overflow-hidden transition-colors duration-500 pt-12 sm:pt-14`}
          style={{
          ...
          <div className="flex items-center justify-center min-h-[80vh] sm:min-h-screen mt-2 sm:mt-4 md:-mt-1 px-4 sm:px-8">
            <div className="text-center max-w-6xl mx-auto relative z-10">
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(180deg, #000000 0%, #333333 20%, #808080 50%, #C0C0C0 80%, #E8E8E8 100%)",
                }}
              >
                About Us
              </div>
              ...
              <h1
                ...
                } mb-6 sm:mb-8 font-subheading font-light leading-tight animate-in slide-in-from-bottom-4 delay-200 transition-colors duration-500 px-2`}
              >
                Bridging Technology & Intelligence for a Smarter Tomorrow – A
                Leading Robotics Company in India
              </h1>

              <p
                className={`text-sm sm:text-base md:text-lg lg:text-xl ${
                  isDarkTheme ? "text-gray-300" : "text-gray-700"
                } leading-relaxed max-w-4xl mx-auto mb-3 sm:mb-12 animate-in slide-in-from-bottom-4 delay-400 transition-colors duration-500 px-2`}
              >
                We revolutionize education by combining advanced robotics,
                AI,hands-on learning and{" "}
                <a href="/School" className="text-green-500">
                  {" "}
                  STREAM Education{" "}
                </a>{" "}
                to prepare students for the challenges of tomorrow. Through
                innovative STEM programs and intelligent automation, Bidyut is
                building the foundation for India's technological future, one
                student at a time. As a top robotics company in India, we
                empower children to explore, learn, and innovate with
                confidence.
              </p>
        ...
        <div
          ...
          className={`relative flex flex-col items-center justify-center min-h-[300px] sm:min-h-[400px] md:min-h-[500px] w-full max-w-[1200px] overflow-visible ${
            isDarkTheme ? "bg-black" : "bg-white"
          } py-1 sm:py-2 md:py-4 px-0 sm:px-1 md:px-2 transition-colors duration-500 mx-auto`}
        >
          <div
          ...
          <div className="relative z-10 w-full max-w-[400px] sm:max-w-[600px] md:max-w-[800px] lg:max-w-[1000px] xl:max-w-[1200px] rounded-2xl shadow-2xl overflow-hidden aspect-video flex items-center justify-center">
            ...
            <div
              className={`absolute inset-0 pointer-events-none transition-all duration-700 ease-out z-20 ${
                isVideoInView
                  ? "ring-4 sm:ring-8 ring-blue-400/40 scale-105 opacity-100"
        ...
        <div
          className={`${
            isDarkTheme ? "bg-black" : "bg-white"
          } px-4 py-8 sm:py-12 transition-colors duration-500`}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-8 sm:mb-12 md:mb-16 max-w-7xl mx-auto">
              <h2
                className={`font-heading font-bold leading-tight tracking-tight ${
                  isDarkTheme ? "text-white" : "text-black"
                } text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl px-4 drop-shadow-lg`}
              >
                {/* Mobile only: 3 lines */}
                <span className="block md:hidden">
                  <span className="block">
                    Bidyut Focuses on Educating Students to act with
                  </span>
                  <span className="block">
                ...
                <span className="hidden md:block">
                  <h2 className="block">
                    Bidyut Focuses on Educating Students to act with Integrity
            ...
            <div className="text-center mb-12 sm:mb-16 md:mb-20">
              <p
                className={`${
                  isDarkTheme ? "text-gray-400" : "text-gray-600"
                } text-base sm:text-lg max-w-4xl mx-auto leading-relaxed px-4`}
              >
                Bidyut's imperative is to bring the future of education to you
                on a mission to uplift the education system of India by
                providing the world's most advanced robotic and technological
                education, integrated with STREAM Education, to the children of
                our country. As a leading robotics company in India, we strive
                to make technology accessible to every student.
              </p>
            </div>
        ...
        {/* Our Journey Section */}
        <div
          className={`relative min-h-0 sm:min-h-[70vh] ${
            isDarkTheme ? "bg-black" : "bg-white"
          } flex flex-col items-center justify-center px-0 sm:px-1 md:px-2 py-1 sm:py-4 md:py-6 transition-colors duration-500`}
        >
          <div className="text-center  ">
            <h2
            ...
            <p
              className={`${
                isDarkTheme ? "text-gray-300" : "text-gray-700"
              } text-base sm:text-lg max-w-4xl mx-auto leading-relaxed transition-colors duration-500 px-4`}
            >
              Pioneering the Future of Energy - From vision to reality, we have
              redefined the energy landscape through relentless innovation and
              steadfast commitment. With each leap forward, we’ve pushed the
              limits of what energy can do—creating sustainable progress and
              inspiring change across the globe.
            </p>
          </div>
          ...
          <div className="relative w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-2xl mb-8">
            <div
              className={`relative ${
                isDarkTheme ? "bg-gray-800" : "bg-gray-200"
              } rounded-lg p-3 sm:p-4 md:p-6 shadow-2xl transition-colors duration-500`}
            >
              <div
                className={`${
                  isDarkTheme ? "bg-white" : "bg-black"
                } rounded-lg border-2 sm:border-4 ${
                  isDarkTheme ? "border-gray-300" : "border-gray-600"
              ...
              <div className="flex justify-center mt-2 sm:mt-4">
                <div
                  className={`w-16 sm:w-24 md:w-32 h-3 sm:h-4 md:h-6 ${
              ...
              <div className="flex justify-center">
                <div
                  className={`w-24 sm:w-32 md:w-48 h-2 sm:h-3 md:h-4 ${
                    isDarkTheme ? "bg-gray-700" : "bg-gray-500"
          ...
          <div className="flex items-center justify-between w-full max-w-6xl mb-4 px-4">
            <div className="w-12 sm:w-16 md:w-24">
              <button
                ...
                } transition-all duration-200 hover:scale-105 disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:scale-100`}
            ...
            <div className="text-center flex-1">
              <h3
                className={`${
                  isDarkTheme ? "text-white" : "text-black"
                } text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-heading font-bold leading-none transition-colors duration-500`}
              >
                {currentItem.year}
              </h3>
            </div>
          ...
          <div
            className={`${
              isDarkTheme ? " text-white" : " text-black"
            } flex items-center justify-center w-full max-w-6xl mb-16 `}
          >
            {/* Year Display */}
              ...
              >
               ...
               {currentItem.year}
                ...
                <h2
                  className={`${
                    isDarkTheme ? " text-white" : " text-black"
                  } text-lg sm:text-xl md:text-2xl font-subheading font-medium mb-4 sm:mb-6 transition-all duration-700 delay-100 px-4`}
                >
                  {currentItem.title}
                </h2>
                ...
                <p
                  className={`${
                    isDarkTheme ? " text-white" : " text-black"
                  } text-sm sm:text-base md:text-lg leading-relaxed max-w-4xl mx-auto transition-all duration-700 delay-200 px-4`}
                >
        ...
        <div
          ...
          className={`min-h-[60vh] ${
            isDarkTheme ? "bg-black" : "bg-white"
          } py-2 sm:py-4 transition-colors duration-500 relative overflow-hidden`}
          style={{
            background:
          ...
          <div className="max-w-7xl mx-auto px-0 sm:px-2 md:px-4 relative z-10">
            <div className="text-center mb-1 sm:mb-3 md:mb-6">
              ...
              <p
                className={`${
                  isDarkTheme ? "text-gray-400" : "text-gray-600"
                } text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed transition-colors duration-500 mb-1 sm:mb-2 md:mb-4 px-0 sm:px-2`}
              >
                    ...
                    {Array.from({
                      ...
                      <div
                        ...
                        className={`w-1.5 h-1.5 rounded-full transition-all duration-300 ${
                          index === autoScrollIndex ? "bg-white" : "bg-white/40"
                        }`}
                      />
                    ))}
                  </div>
            ...
            {showFullGallery && (
              <div
                ...
                style={{
                  ...
                  transform: galleryAnimationTrigger
            ...
            {selectedImage !== null && (
              ...
              >
                ...
                >
                    ...
                    <div
                      ...
                      style={{
                        background: `linear-gradient(135deg, ${
                          filteredImages[selectedImage]?.bgColor || "#3B82F6"
                        }, transparent 70%)`,
                      }}
                    />
                  ...
                  {/* Content */}
                  <div
                    className={`p-8 transition-all duration-400 ease-out ${
                      isImageTransitioning
                      ...
                      >
                        {
                          galleryCategories.find(
                            (cat) =>
                              cat.id === filteredImages[selectedImage]?.category
                          )?.name
                        }
                      </span>
                    </div>
      ...
      <div className="fixed inset-0 flex items-center justify-center pointer-events-none overflow-hidden px-4">
        <div className="relative">
          {scrollY > 1800 && getTransformedText() === "202O" ? (
            <div
              className={`text-[8rem] sm:text-[10rem] md:text-[12rem] font-bold ${
                isDarkTheme ? "text-white" : "text-black"
                ...
                {[0, 1, 2, 3].map((digitIndex) => {
                  ...
                  return (
                    <div
                      key={digitIndex}
                      className={`
                        text-[8rem] sm:text-[10rem] md:text-[12rem] font-bold ${
                          isDarkTheme ? "text-white" : "text-black"
