...
const sectionTitle = (title: string) => (
	<h2
		className="text-2xl font-bold mb-4 mt-10 text-green-500 border-b-2 border-gray-200 dark:border-gray-700 pb-2"
	>
		{title}
	</h2>
);
			...
			<div className="min-h-screen bg-white dark:bg-black pt-24 md:pt-28">
				<div className="container mx-auto px-4 py-8">
					<div className="w-full max-w-3xl mx-auto px-4 md:px-0">
							<h1 className="text-4xl font-bold mb-8 text-center text-gray-900 dark:text-white">Privacy Policy — <span className="text-[#10b981]">Bidyut Innovation Pvt Ltd</span></h1>
							<p className="text-sm text-gray-500 dark:text-gray-400 mb-8">Effective Date: August 25, 2025<br />Last Updated: August 25, 2025</p>
								<section className="mb-8">
									...
									<p className="mb-2 text-gray-700 dark:text-gray-300 text-lg">
										If any information you provide or upload violates the terms of this Policy or the Terms of Use, we may delete such information upon informing you of the same and revoke your access without incurring liability. Please read this Policy carefully prior to accessing our Platform and using any of the services or products offered. For questions, contact us at <a href="mailto:Info@bidyutrobotics.com" className="text-green-600 dark:text-green-400 underline">Info@bidyutrobotics.com</a>.
									</p>
								</section>
								<section className="mb-8">
									{sectionTitle("1. Personal Information")}
									<p className="mb-2 text-gray-700 dark:text-gray-300">“Personal Information” includes details that identify a User such as:</p>
									...
									<p className="mb-2 text-gray-700 dark:text-gray-300">“Sensitive Personal Information” includes:</p>
									<ul className="list-disc pl-6 mb-2 text-gray-700 dark:text-gray-300">
									...
									<p className="mb-2 text-gray-700 dark:text-gray-300">The term ‘Personal Information’ may encompass ‘Sensitive Personal Information’ when used in this Policy.</p>
								</section>
								<section className="mb-8">
								...
								<section className="mb-8">
									...
									<p className="mt-2 text-gray-700 dark:text-gray-300">We do not use your personal information for automated decision-making without explicit consent.</p>
									<p className="mt-2 text-gray-700 dark:text-gray-300">For users that register on our website (if any), we also store the personal information they provide in their user profile. All users can see, edit, or delete their personal information at any time (except they cannot change their username). Website administrators can also see and edit that information.</p>
								</section>
								<section className="mb-8">
									{sectionTitle("4. Sharing of Information")}
									<p className="mb-2 text-gray-700 dark:text-gray-300">We do not sell or trade your personal information. However, we may share aggregated, non-identifiable information with:</p>
									<ul className="list-disc pl-6 text-gray-700 dark:text-gray-300">
								...
								<section className="mb-8">
									...
									<ul className="list-disc pl-6 text-gray-700 dark:text-gray-300">
										...
										<li>Control Communication Preferences: Opt-out of promotional emails by contacting us at <a href="mailto:Info@bidyutrobotics.com" className="text-green-600 dark:text-green-400 underline">Info@bidyutrobotics.com</a>.</li>
									</ul>
								</section>
								<section className="mb-8">
									...
									<p className="mt-2 text-gray-700 dark:text-gray-300">For any of these rights, contact <a href="mailto:Info@bidyutrobotics.com" className="text-green-600 dark:text-green-400 underline">Info@bidyutrobotics.com</a>.</p>
								</section>
								<section className="mb-8">
									{sectionTitle("7. Data Protection")}
									<p className="text-gray-700 dark:text-gray-300">We implement robust security measures to prevent unauthorized access, alteration, or destruction of your data. While we strive to protect your data, no transmission method is completely secure.</p>
								</section>
								<section className="mb-8">
									{sectionTitle("8. Cross-Border Data Transfers")}
									<p className="text-gray-700 dark:text-gray-300">Your information is stored and processed on secure servers in India (e.g., Amazon Web Services). By using our services, you consent to this transfer, including storage in countries with differing privacy laws.</p>
								</section>
								<section className="mb-8">
									{sectionTitle("9. Retention Policy")}
									<p className="text-gray-700 dark:text-gray-300">We retain your data as long as required for providing services, complying with legal obligations, and business continuity purposes.</p>
								</section>
								<section className="mb-8">
									{sectionTitle("10. Third-Party Websites")}
									<p className="text-gray-700 dark:text-gray-300">The Platform may link to third-party websites. We are not responsible for the privacy practices of these external sites. Review their policies before sharing information.</p>
								</section>
								<section className="mb-8">
									{sectionTitle("11. Changes to this Privacy Policy")}
									<p className="text-gray-700 dark:text-gray-300">We reserve the right to amend this Policy at any time. Changes will be updated on the Platform, and the effective date will reflect the latest revision.</p>
								</section>
								<section className="mb-8">
									{sectionTitle("12. Grievances")}
									<p className="text-gray-700 dark:text-gray-300">For grievances, queries, or rights-related issues, contact:</p>
