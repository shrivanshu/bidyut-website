...
function Home_page() {
  ...
  return (
    ...
    >
      ...
      {/* Trusted Partners */}
       <section className="min-h-screen flex items-center justify-center p-2 sm:p-8   select-none">
          <style >{`
            @keyframes wave-flow {
              0% {
                stroke-dashoffset: 0;
          ...
          <div className="max-w-7xl w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-16 items-center">
              ...
              <div className="space-y-8 relative">
                ...
                >
                  <h1 className="text-5xl lg:text-6xl font-bold text-black dark:text-white mb-4">
                    <HomeHeroText
