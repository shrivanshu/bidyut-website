...
export default function ContactPage() {
  ...
  return (
    <div
      className={`flex flex-col min-h-screen transition-colors duration-300 ${bgColor}`}
    >
      <SEO
      ...
      <main className="flex-1">
        ...
        >
          ...
          <div className="absolute inset-0">
            ...
            {/* Fade Overlay */}
            <div
              className="absolute inset-0 rounded-b-[80px] bg-gradient-to-t 
        ...
        <section className={`py-20 ${bgColor}`}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2">
              <div
                className={`rounded-2xl shadow-xl p-10 border ${bgColor} ${borderColor}`}
              >
                {/* Success Message */}
                {showSuccess && (
                  <motion.div
                ...
                <h2
                  className={`text-3xl font-heading font-bold mb-4 ${textColor}`}
                >
                  Contact Us
                </h2>
                ...
                >
                  ...
                  <input
                    type="hidden"
                    name="accessKey"
                    value="sf_m38f9317i2e053l3h9937cf7"
                  />
                  <input
                    type="hidden"
                    name="redirectTo"
                    value="https://bidyutinnovation.com/contact?success=true"
                  />
                  {/* Name */}
                  <div className="relative">
                    <input
                      ...
                      type="text"
                      required
                      className={`peer w-full px-4 pt-5 pb-2 border-b-2 bg-transparent placeholder-transparent focus:outline-none focus:border-[#00F5A0] ${
                        isDark
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      rows={5}
                      required
                      className={`peer w-full px-4 pt-5 pb-2 border-b-2 bg-transparent placeholder-transparent focus:outline-none focus:border-[#00F5A0] resize-none ${
                        isDark
                          ? "border-gray-700 text-white"
                          : "border-gray-300 text-gray-900"
                      }`}
            ...
            {/* Studio Info */}
            <div
              className={`rounded-2xl p-10 shadow-xl border ${bgColor} ${textColor} ${borderColor}`}
            >
              <h3 className="text-xl font-subheading font-bold mb-6 text-[#00F5A0]">
                {t("ourStudio")}
              </h3>
              ...
              >
                <div>
                  <h4 className="font-semibold text-[#00F5A0] mb-1">
                    {t("addressLabel")}
                  </h4>
                  <p>
                ...
                <div>
                  ...
                  <p>
                    <a href="tel:+919370782979">+91 9370782979</a>
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-[#00F5A0] mb-1 flex items-center gap-2">
                  ...
                  <p>
                    <a href="mailto:Info@bidyutrobotics.com">
